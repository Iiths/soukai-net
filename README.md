...
- 名前・別名・本名での部分一致検索
- リアルタイム検索結果表示
- ニンジャカード一覧（**あいうえお順**でソート）

### 2. 詳細検索 (`/search`)
- 複数条件でのフィルタ（結果は**あいうえお順**でソート）
  - 登場部（第X部）
  - ニンジャソウル名
  - 所属組織
  - ステータス（生存/死亡/不明）
  - ニンジャタイプ（ニンジャソウル憑依者 / リアルニンジャ / ロボ・ニンジャ / バイオニンジャ / 非ニンジャ / カツ・ワンソーの影）
